...
_zerothshot = [camstart, camstart, focuspoint, 5, 0.95, 1, false, 0, 0, 0,FALSE] execVM "AL_intro\camera_work.sqf";
waitUntil {scriptdone _zerothshot};
/*
_txt_5 = ["TerminalHunter presents",4,"center_bottom","1","#dddddd"] execVM "AL_intro\txt_display.sqf";
[] spawn {
sleep 6;
_txt_6 = ["Fallout: Boreas",6,"center_top","2","#c49102"] execVM "AL_intro\txt_display.sqf";
};
*/

_firstshot = [camstart, camend, focuspoint, 60, 1, 1, false, 0, 0, 0,TRUE] execVM "AL_intro\camera_work.sqf";
