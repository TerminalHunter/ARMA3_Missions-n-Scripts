serverRunAutodoc = {
  ...
  if (count _detectedEnemies == 0) then {
    ...
    [_autodoc] spawn {
      ...
      _helperCircle setPos ((getPos _helperCircle) vectorAdd [0,0,0.3]);
      //SPEEEN!
      [_helperCircle] spawn {
        params ["_spinner"];
        ...
        while {alive _spinner} do {
          ...
          _dum = getPos _spinner;
          _spinner setPos _dum;
        };
      };
      sleep 10;
      ...
      ["Administration Complete.\nDispensing Good Boy and/or Good Girl Lollipop."] remoteExec ["shorterHint",0,false];
    };
  } else {
