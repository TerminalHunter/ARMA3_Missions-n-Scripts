...
seecret addAction ["SECRET RADIO #ILOSTCOUNT2", {
  playSound3D ["Hyperborea_Music\Canadia.ogg", seecret];
  removeAllActions seecret;
},[],1.5,true,true,"","true",10,false,"",""];

setDate [2283,4,16,3,40];

wife addAction ["Don't shoot! Civilians!", {
      _longString = "<t color='#777777' size='1'>Please, we're not in anyone's way.</t>";
      [_longString] call storyText;
},[],1.5,true,true,"","alive wife",10,false,"",""];

wife addAction ["Mention her husband and ask her to come with you", {
      _longString = "<t color='#777777' size='1'>Good to hear he's safe. But... leave? I've got 8 patients to look after, here. They'll die if I leave.</t>";
      [_longString] call storyText;
},[],1.5,true,true,"","alive wife",10,false,"",""];
