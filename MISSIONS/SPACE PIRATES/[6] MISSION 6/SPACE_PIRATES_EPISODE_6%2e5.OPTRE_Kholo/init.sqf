...
//make sure people can spawn vehicles
if (isServer) then {
  waitUntil {time > 10};
...
lostAPC sethit ["wheel_1_1_steering", 1];
lostAPC sethit ["wheel_1_2_steering", 1];
lostAPC sethit ["wheel_2_1_steering", 1];
lostAPC sethit ["wheel_2_2_steering", 1];
lostAPC sethit ["wheel_1_3_steering", 1];
lostAPC sethit ["wheel_2_3_steering", 1];
...
<br/>
We've found a few scant traces of life, bits of information... and some explodey bois. There's still a few minor things to trace, but boy is there not all that much around here.<br/>
---<br/>
<br/>
PREVIOUS SITUATION:<br/>
<br/>
This place is dead. Like... DEAD dead.<br/>
<br/>
Problems started with interference just getting here. Right before the warp broke above the planet we were having issues. More-so than the typical Thrawn-based tech issues.<br/>
<br/>
And yeah, this planet looks like it has issues. We're safe at the moment - but we should figure out what potential larceny or trade the previous intel we found is pointing to.<br/>
<br/>
Objectives:<br/>
Figure out what to do here.

code to grab hit points on a vehicle.
dunno why wheels are so hard to access....
doThing =
...
lostAPC call doThing;

["sc_tracked\data\mantis\textures\body_olive_co.paa",
"sc_tracked\data\mantis\textures\turret_olive_co.paa",
"sc_tracked\data\mantis\textures\brace_olive_co.paa"]
...
["sc_tracked\data\mantis\textures\body_desert_camo_co.paa",
"sc_tracked\data\mantis\textures\turret_desert_camo_co.paa",
"sc_tracked\data\mantis\textures\brace_desert_camo_co.paa"]

["sc_tracked\data\mantis\textures\body_tan_co.paa",
"sc_tracked\data\mantis\textures\turret_tan_co.paa",
"sc_tracked\data\mantis\textures\brace_tan_co.paa"]
