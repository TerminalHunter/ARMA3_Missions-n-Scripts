//warcrimes apparently require an extra 150 lines of code
//from https://forums.bohemia.net/forums/topic/215096-wear-what-you-want/

//all this does is let you wear any uniform (with some finagling)
