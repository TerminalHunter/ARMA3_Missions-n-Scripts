...
randomizedObjectiveObjects = [
  ...
  //main hangar
  [hangarFabricator, "the weird machine with arms in the Main Hangar.", mainHangarDirectory],
  ...
  [waterDispenser, "leaking what we hope is water. It's in the water dispenser in the Gym.", gymDirectory],
  //squad bay 1
  ...
  [starboardSideStarboardBankStarboardEngineInterface, "accessible via Starboard-Bank Starboard-Side interface screen in the Port Engine Room.", leftEngineRoomDirectory],
  [portSideStarboardBankStarboardEngineInterface, "accessible via Starboard-Bank Port-Side interface screen in the Port Engine Room.", leftEngineRoomDirectory],
  [starboardSidePortBankStarboardEngineInterface, "accessible via Port-Bank Starboard-Side interface screen in the Port Engine Room.", leftEngineRoomDirectory],
...
masterObjectiveTable = [
  ...
  ["Draw a dick on the whiteboard", ["Draw a dick", whiteboard, "The Whiteboard", {}, "Draw a dick"]],
  //slip drive
...
directoryInit = {
  ...
  [dataRoomDirectory,["The Router is on the floor in the Data Room.",{},[],1.5,true,true,"","true",10,false,"",""]] remoteExec ["addAction", 0, true];
