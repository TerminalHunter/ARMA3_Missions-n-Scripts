...
},[],11,true,true,"","bomberUnlock",10,false,"",""];
...
vehicleSpawner addAction ["[PLANE] Replicate Space JAS 39 - DANGER CLEAR FLIGHT DECK", {
  ["I_Plane_Fighter_04_F"] call replicateNewVehicleFromPonyExpress;
},[],9.9,true,true,"","true",10,false,"",""];
...
replicateNewVehicleFromPonyExpress = {
  ...
  },[],15,true,true,"","_originalTarget distance vehicleSpawner < 40",10,false,"",""];
};
