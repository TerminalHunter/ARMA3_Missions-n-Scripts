rawArtyStrike = {
	params ["_gridCoord"];
	_nearPosition = [_gridCoord] call BIS_fnc_gridToPos;
	...
	sleep 30;
	[_realPosition] spawn BIS_fnc_fireSupportVirtual;
	[_realPosition] spawn BIS_fnc_fireSupportVirtual;
	_strikeArea = createMarker["ARTY"+str(random 10), _realPosition];
	_strikeArea setMarkerSize [50,50];
	[_strikeArea] call blowAreaTheFuckUp;
	sleep 80;
